...
def elapsed_time_in_minutes(number_of_layers, elapsed_bake_time):
    ...
    minutes_this_lasagna_shoul_be_in_oven = preparation_time_in_minutes(number_of_layers)
    elapsed_time = minutes_this_lasagna_shoul_be_in_oven + elapsed_bake_time
    return elapsed_time 
